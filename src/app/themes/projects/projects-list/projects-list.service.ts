...
export class ProjectsListService {
  ...
  fullListItem = this.projectsSubject.asObservable().pipe(
    map((item) =>
      item.map((innerItem) => ({ attributes: innerItem.attributes }))
    ),
    first()
  );
  ...
  runProjectsQuery(urlStr: string, queryExpression: any, inputValue) {
    ...
    const valueAutocomplete =
      inputValue.length > 0
        ? "((Pavadinimas LIKE '%" +
          inputValue.charAt(0).toLowerCase() +
          inputValue.slice(1) +
          "%')" +
          " OR " +
          "(Pavadinimas LIKE '%" +
    ...
    typeof queryExpression !== "undefined"
  ...
  getPopUpContent(attributes: any, selection: string = "") {
    ...
    const galleryImages = (() => {
      ...
      if (attributes.PAV == 1) {
        ...
        // tslint:disable-next-line: max-line-length
        galleryTitle =
          '<p>Nuotraukų galerija:</p><img id="gallery-loader" style="width: 20px; margin: 20px auto; display: block" src="./assets/img/ajax-loader.gif">';
        ...
        switch (parseInt(attributes.PAV_K)) {
          case 2:
            arr = [
              {
                thumbnail:
                  "assets/img/projects/thumbnail/U_" + uniqueID + "_1_tn.jpg", // image src for the thumbnail
                image: "assets/img/projects/U_" + uniqueID + "_1.jpg", // , //image src for the image
                // text: Tema //optional text to show for the image
              },
              {
                thumbnail:
                  "assets/img/projects/thumbnail/U_" + uniqueID + "_2_tn.jpg", // image src for the thumbnail
          ...
          case 3:
            arr = [
              ...
              {
                thumbnail:
                  "assets/img/projects/thumbnail/U_" + uniqueID + "_3_tn.jpg", // image src for the thumbnail
          ...
          case 4:
            arr = [
              ...
              {
                thumbnail:
                  "assets/img/projects/thumbnail/U_" + uniqueID + "_4_tn.jpg", // image src for the thumbnail
          ...
          case 5:
            arr = [
              ...
              {
                thumbnail:
                  "assets/img/projects/thumbnail/U_" + uniqueID + "_5_tn.jpg", // image src for the thumbnail
          ...
          case 6:
            arr = [
              ...
              {
                thumbnail:
                  "assets/img/projects/thumbnail/U_" + uniqueID + "_6_tn.jpg", // image src for the thumbnail
    ...
    // tslint:disable-next-line: max-line-length
    const busena =
      '<p><span>Projekto būsena</span><br /><span class="type-' +
      attributes.Busena[0] +
      ' projects-theme"></span>' +
      attributes.Busena +
      "</p>";
    const statusas = attributes.Statusas
      ? "<p><span>Etapas</span><br />" + attributes.Statusas + "</p>"
      : "";
    const partneris = attributes.Projekto_partneris
      ? "<p><span>Partneris</span><br />" +
        attributes.Projekto_partneris +
        "</p>"
      : "";
    const projektoAprasymas = attributes.Projekto_aprasymas
      ? "<p><span>Aprašymas</span><br />" +
        attributes.Projekto_aprasymas +
        "</p>"
      : "-";
    const igyvendNuo = attributes.Igyvend_NUO ? attributes.Igyvend_NUO : "-";
    const igyvendIki = attributes.Igyvend_IKI
      ? "– " + attributes.Igyvend_IKI
      : "";
    // Lesos : remove values of sum in EURO that eaquals 0 string
    const projektoVerte = attributes.Projekto_verte
      ? attributes.Projekto_verte[0] !== "0"
        ? "<p><span>Projekto vertė</span><br />" +
          attributes.Projekto_verte +
          " Eur</p>"
        : ""
      : "";
    const esInvesticijos = attributes.ES_investicijos
      ? attributes.ES_investicijos[0] !== "0"
        ? "<p><span>Europos Sąjungos investicijos</span><br />" +
          attributes.ES_investicijos +
          " Eur</p>"
        : ""
      : "";
    const savivaldybesBiudzetoLesos = attributes.Savivaldybes_biudzeto_lesos
      ? attributes.Savivaldybes_biudzeto_lesos[0] !== "0"
        ? "<p><span>Savivaldybės biudžeto lėšos</span><br />" +
          attributes.Savivaldybes_biudzeto_lesos +
          " Eur</p>"
        : ""
      : "-";
    const valstybesBiudzetoLesos = attributes.Valstybes_biudzeto_lesos
      ? attributes.Valstybes_biudzeto_lesos[0] !== "0"
        ? "<p><span>Valstybės biudžeto lėšos</span><br />" +
          attributes.Valstybes_biudzeto_lesos +
          " Eur</p>"
        : ""
      : "";
    const kitosViesosiosLesos = attributes.Kitos_viesosios_lesos
      ? attributes.Kitos_viesosios_lesos[0] !== "0"
        ? "<p><span> Kitos viešosios lėšos</span><br />" +
          attributes.Kitos_viesosios_lesos +
          " Eur</p>"
        : ""
      : "";
    const privaciosLesos = attributes.Privacios_lesos
      ? attributes.Privacios_lesos[0] !== "0"
        ? attributes.Privacios_lesos[0] !== "N"
          ? "<p><span> Privačios lėšos</span><br />" +
            attributes.Privacios_lesos +
            " Eur</p>"
          : ""
        : ""
      : "";
    ...
    const nuorodaPr = attributes.Nuoroda_i_projekta
      ? attributes.Nuoroda_i_projekta.slice(0, 4) === "http"
        ? // tslint:disable-next-line: max-line-length
          '<p><span>Projekto nuoroda</span><br /><a href="' +
          attributes.nuorodaPr +
          '" target="_blank">' +
          attributes.Nuoroda_i_projekta +
          "</a></p>"
        : '<p><span>Projekto nuoroda</span><br /><a href="http://' +
          attributes.Nuoroda_i_projekta +
          '" target="_blank">' +
          attributes.Nuoroda_i_projekta +
          "</a></p>"
    ...
    const kontaktai = attributes.Kontaktai
      ? '<p><span>Kontaktai</span><br /><a href="mailto:' +
        attributes.Kontaktai +
        '">' +
        attributes.Kontaktai +
        "</a></p>"
      : "";
    ...
    if (selection !== "selection") {
      this.projectsSubject.next(galleryImages);
    }
