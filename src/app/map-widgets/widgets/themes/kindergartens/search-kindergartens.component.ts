...
export class SearchKindergartensComponent implements AfterViewInit  {
  ...
  ngAfterViewInit(): void {
    this.searchWidget = this.searchService.kindergartensSearchWidget(this.mapService.getView(),
      this.searchWidgetDOM.nativeElement, 'Adresas, pvz.: Konstitucijos pr. 3');
