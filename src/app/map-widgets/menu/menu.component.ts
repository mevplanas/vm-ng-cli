...
import { ProfileToolContainerComponent } from './tools/profile/profile-tool-container.component';
import { SwipeToolService } from './tools/swipe/swipe-tool.service';
import { SwipeToolContainerComponent } from './tools/swipe/swipe-tool-container.component';
import { tap, filter } from 'rxjs/operators';

@Component({
  selector: 'maps-v-menu',
...
export class MenuComponent implements OnInit, OnDestroy {
  ...
  componentsVisibleSubLayerNumberState = 1;
